...
// 	window = glfwCreateWindow(RESOLUTION_X, RESOLUTION_Y, "Kana Particle System", nullptr, nullptr);
// 	if (!window)
// 	{
// 		glfwTerminate();
// 		return -1;
...
int main(int, char**)
{
	...
	GLFWwindow* window = glfwCreateWindow(1280, 720, "Kana Particle System", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		kana.Update(static_cast<float>(deltaTime));
		kana.Render();
